...
const ROTAS_FECHAMENTO = new Set(['/razao', '/consulta', '/documentos', '/integracao', '/conciliacao', '/comparativo', '/sugestoes', '/outras', '/contabilizar', '/relatorios', '/painel-cliente', '/status', '/base'])
...
const FECHAMENTO = [
  ...
  { to: '/consulta', icon: 'ti-file-search', label: 'Consulta de Lançamentos' },
    ...
    <div style={{ display: 'flex', height: '100vh', overflow: 'hidden' }}>
      ...
      <aside style={{ width: colapsado ? 72 : 248, background: theme.sidebar, display: 'flex', flexDirection: 'column', flexShrink: 0, transition: 'width .2s ease', height: '100vh', overflowY: 'auto' }}>
        ...
        <nav style={{ padding: colapsado ? '4px 12px' : '4px 8px', flex: 1, overflowY: 'auto' }}>
          ...
          <Item to="/importacoes" icon="ti-file-upload" label="Ações em Massa" colapsado={colapsado} />
