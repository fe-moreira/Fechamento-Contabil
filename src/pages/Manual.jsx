...
<section id="m-integracao">
  ...
  <div class="m-rule warn"><span class="k">Perfil de leitura — 1ª vez, por banco</span> O perfil é <b>por banco</b> (cada conta contábil tem o seu): um cliente com Itaú e Bradesco, por exemplo, exporta layouts diferentes, então cada banco guarda seu próprio mapeamento. Para cada banco, a <b>primeira</b> importação é feita <b>aqui na Integração</b>: o sistema mostra o mapeamento das colunas (Data · Valor · Histórico · D/C) — confira em <b>“Ajustar leitura”</b> e salve. Isso grava o <b>perfil daquele banco</b>. A partir daí, subir o Excel daquele banco (individual ou em massa) já classifica sozinho. Sem o perfil do banco, o upload marca o documento como recebido mas <b>não</b> alimenta a Integração — e avisa que falta configurar o perfil.</div>
  <div class="m-rule"><span class="k">Vários arquivos no mês</span> Com o banco aberto e já com lançamentos, há <b>dois botões explícitos</b>: <b>Substituir arquivo</b> (troca tudo pelo novo extrato) e <b>Importar complemento</b> (soma os lançamentos de outro arquivo aos que já estão, sem apagar nada — ex.: 2º extrato para fechar o mês). Cada botão faz exatamente o que diz, sem pergunta. Dá também para <b>excluir em lote</b> as linhas selecionadas e filtrar por <b>nome da conta</b> (contém/não contém) e por <b>sem data</b>. Linhas de <b>total/subtotal</b> do relatório não sobem.</div>
</section>
