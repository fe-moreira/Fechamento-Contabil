...
<section id="m-conciliacao">
  ...
  <div class="m-rule"><span class="k">Selecionar para vincular (contas sem entidade)</span> Nas contas de <b>composição/reclassificação</b> que não são agrupadas por cliente/fornecedor (ex.: reclassificações “não identificadas”), a lista de lançamentos também tem <b>checkbox</b> na primeira coluna: marque dois ou mais e use <b>Conectar (baixar)</b> na barra que aparece embaixo, igual às contas por entidade.</div>
