...
<section id="m-conciliacao">
  ...
  <div class="m-rule"><span class="k">Desvincular nomes unidos por engano</span> Se o sistema uniu dois nomes parecidos que são <b>clientes/fornecedores diferentes</b> (ex.: “ATTENTIVE SERVIÇOS ADM” e “ATTENTIVE CONTABILIDADE”), abra o lançamento (clique na linha) → em <b>Ajustar leitura</b> há o botão <b>“Desvincular”</b>: mantém esse nome separado dos parecidos, <b>valendo para todos os meses</b>. É uma regra do cliente, guardada no cadastro. O desvínculo <b>acompanha o rename</b>: se você <b>desvincular e depois mudar o nome</b> daquele fornecedor, o nome novo continua desvinculado (os dois seguem separados).</div>
