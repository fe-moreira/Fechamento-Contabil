...
<section id="m-demonstracoes">
  ...
  <div class="m-rule"><span class="k">Balanço fecha com o resultado no PL</span> O <b>Balanço</b> (tanto o card em Relatórios quanto o das Demonstrações) usa o <b>mesmo cálculo</b> (<span class="m-code">apurarBalanco</span>): separa Ativo e Passivo+PL pela <b>classificação</b> (grupo 1 e 2) e joga o <b>resultado do período</b> (receita − custo − despesa, o mesmo do DRE/Comparativo) no PL como <b>Lucros do Exercício</b> (se positivo) ou <b>Prejuízo do Exercício</b> (se negativo). Assim <b>Ativo = Passivo + PL</b> sempre fecha, sem precisar cadastrar conta de resultado — o valor é apurado na hora.</div>
