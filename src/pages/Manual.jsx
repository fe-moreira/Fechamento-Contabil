...
<section id="m-conciliacao">
  ...
  <div class="m-rule"><span class="k">Nome do cliente/fornecedor pela NF do Fiscal</span> Quando o histórico do razão <b>não</b> deixa claro o nome, a plataforma busca o nome <b>oficial da nota</b> na <b>Integração Fiscal</b>: o acumulador (Entradas = fornecedores; Saídas/Serviços = clientes) traz o nome bem definido por <b>NF</b>. Se a <b>NF</b> da linha bate com uma NF do fiscal, o nome de lá é usado para <b>identificar</b> a linha — some do “não identificado”. É <b>padrão do sistema</b> para todos os clientes; correções manuais e apelidos continuam tendo prioridade.</div>
  <div class="m-rule"><span class="k">Nome sem o prefixo do tipo de conta</span> Nas contas de <b>Adiantamento de Fornecedor</b> e <b>Adiantamento de Cliente</b>, o Domínio escreve o nome com o tipo da conta na frente (ex.: <b>“ADIANTAMENTO DE FORNECEDOR CONNECT FOR PEOPLE EDITORA E SOLUCOES 003881”</b>). A plataforma <b>tira esse prefixo</b> (e o código no fim) e identifica o cliente/fornecedor real — <b>“CONNECT FOR PEOPLE EDITORA E SOLUCOES”</b> — tanto no saldo inicial quanto no razão, para agrupar certo na composição.</div>
