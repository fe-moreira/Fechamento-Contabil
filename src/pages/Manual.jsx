...
<section id="m-comparativo">
  ...
  <ul>
    ...
    <li><b>Filtro por Centro de custo</b> (só para clientes que <b>usam centro de custo</b>): aparece um filtro <b>Centro de custo</b> na barra, com <b>marcar todos</b> ou seleção individual (igual ao de Meses). Ao escolher centros, o <b>resultado</b> (receitas/despesas) passa a considerar <b>só os lançamentos daqueles centros</b> — inclusive os subtotais das sintéticas e o Resultado do Mês/Exercício, e vale também no Excel/PDF. As contas <b>patrimoniais</b> (1 e 2) não têm centro de custo, então <b>não são afetadas</b>. <b>Sem nada selecionado = todos</b> (idêntico ao de hoje). O centro de custo é lido do <b>razão</b>; lançamentos de resultado sem centro aparecem como <b>"(sem centro)"</b> na lista.</li>
  </ul>
</section>
