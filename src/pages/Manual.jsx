...
<section id="m-massa">
  ...
  <p>Gera o relatório de <b>Distribuição de Lucros / JCP</b> de <b>todas as empresas</b> de uma vez, num <b>único zip</b> com <b>um PDF por empresa</b>. Cada PDF separa os sócios <b>por conta contábil</b> (o que está em Ata × Exercício fica em contas distintas) e traz Nome, CPF, Data do pagamento e Valor, com subtotal por conta e total geral. Entram os pagamentos cuja <b>data de pagamento</b> cai no período.</p>
  <div class="m-rule"><span class="k">Período e nome do arquivo</span> Escolha <b>Mensal</b>, <b>Trimestral</b>, <b>Semestral</b> ou <b>Anual</b>. O período nomeia cada arquivo: <b>202601</b> (mês), <b>1T2026</b> (trimestre), <b>1S2026</b> (semestre) ou <b>2026</b> (ano). Padrão: <b>Código - Nome da Empresa - «Período» - Distribuição de Lucros_JCP.pdf</b> (a barra “/” vira “_” no nome do arquivo; no título dentro do PDF fica “/”). O <b>CPF</b> vem do cadastro em <b>Base de Informações → Distribuição de Lucros</b> (obrigatório para novos sócios).</div>
</section>
...
<section id="m-integracao">
  ...
  <div class="m-rule"><span class="k">Fiscal — matriz + filiais (substituir × complementar)</span> Na aba <b>Fiscal</b>, cada tipo (<b>Entradas</b>, <b>Saídas</b>, <b>Serviços</b>) cruza o acumulador do Domínio com o razão. Quando o tipo <b>já tem</b> arquivo e você importa <b>outro</b>, o sistema pergunta <b>Substituir</b> (troca tudo pelo novo) ou <b>Complementar</b> — que <b>junta as linhas</b> do novo arquivo com as que já estavam, sem apagar nada, e recalcula o cruzamento sobre o total. É o caminho para empresas com <b>matriz e filiais</b>: cada arquivo é de um estabelecimento e o Complementar soma todos no mesmo tipo. Se o tipo ainda estava vazio, o primeiro arquivo entra direto (sem perguntar). Cada arquivo do tipo aparece <b>listado</b>, com quantas linhas trouxe, um botão para <b>baixar</b> e um para <b>excluir só aquele arquivo</b> (as linhas dele saem do total; os outros continuam e o cruzamento recalcula na hora). O mesmo vale no <b>Resumo por Acumulador (Domínio)</b> (aba <b>Resumo final</b>): é um <b>PDF</b>, aceita <b>mais de um arquivo</b> (matriz + filiais) e, no <b>Complementar</b>, <b>soma os totais de cada seção</b> (Entradas/Saídas/Serviços) dos PDFs para conferir com o acumulador importado. Todos os PDFs subidos ficam listados, com baixar e excluir individual.</div>
...
<section id="m-conciliacao">
  ...
  <div class="m-rule"><span class="k">Avisos em chips (filtrar por situação)</span> Os avisos da composição ficam numa <b>linha única de chips</b>, agrupados por <b>Precisa de ação</b> (saldo em natureza invertida, baixa com NF sem título, leitura incerta) e <b>Conferir</b> (NF aproximada, nomes unificados). Cada chip mostra a <b>quantidade</b> e um rótulo curto. <b>Clique</b> num chip para ver o detalhe completo logo abaixo e <b>filtrar</b> a lista só naquela situação; clique de novo (ou “limpar”) para voltar. <b>NF aproximada</b> marca os pares cuja NF só bate <b>ignorando zeros à esquerda</b> (ex.: 05602823 × 5602823): esses <b>não</b> são baixados no automático (a NF não é idêntica) e ficam como <b>sugestão</b> para você aprovar em lote se for o mesmo título. Chip com contagem zero não aparece; sem nenhum aviso, a linha some. O aviso de <b>“leitura incerta”</b> só conta o que <b>ainda não foi tratado</b>: ao conferir/corrigir (ou confirmar o nome), a linha sai da conta.</div>
  <div class="m-rule"><span class="k">Nome do cliente/fornecedor pela NF do Fiscal</span> Quando o histórico do razão <b>não</b> deixa claro o nome, a plataforma busca o nome <b>oficial da nota</b> na <b>Integração Fiscal</b>: o acumulador (Entradas = fornecedores; Saídas/Serviços = clientes) traz o nome bem definido por <b>NF</b>. Se a <b>NF</b> da linha bate com uma NF do fiscal, o nome de lá <b>substitui</b> a leitura do histórico — é o nome <b>oficial da nota</b> (ex.: histórico “COFINS MIRAGE RESIDENCE SPE” passa a mostrar o cliente correto do fiscal). É <b>padrão do sistema</b> para todos os clientes; só não sobrepõe um ajuste manual do saldo inicial, e apelidos (renomear em todo lugar) ainda vêm por cima.</div>
  <div class="m-rule"><span class="k">Nome sem o prefixo do tipo de conta</span> Nas contas de <b>Adiantamento de Fornecedor</b> e <b>Adiantamento de Cliente</b>, o Domínio escreve o nome com o tipo da conta na frente (ex.: <b>“ADIANTAMENTO DE FORNECEDOR CONNECT FOR PEOPLE EDITORA E SOLUCOES 003881”</b>). A plataforma <b>tira esse prefixo</b> (e o código no fim) e identifica o cliente/fornecedor real — <b>“CONNECT FOR PEOPLE EDITORA E SOLUCOES”</b> — tanto no saldo inicial quanto no razão, para agrupar certo na composição. Vale também para <b>Adiantamento de Clientes</b> e para <b>prefixos de imposto</b> coladas no nome (COFINS, PIS, ICMS, ISS, IRPJ, CSLL, IRRF, INSS, IPI…) — todos são removidos do começo do nome.</div>
