...
<section id="m-fechamentos">
  ...
  <div class="m-rule"><span class="k">Botões no card (Encerrar / Reabrir)</span> Na lista de <b>Fechamentos</b>, cada card mostra a ação direto: o card <b>Concluído (100%)</b> tem o botão <b>Encerrar</b> (abre o Status para você importar o balancete e encerrar formalmente). Depois de encerrar, o card fica <b>verde “Encerrado”</b> e ganha o botão <b>Reabrir</b> (só <b>administrador</b>): ao clicar, ele <b>pergunta se você tem certeza</b> e, confirmando, a competência volta a ficar <b>aberta</b> para edição — sem telas extras. Clicar no corpo do card sempre <b>abre</b> a competência (a encerrada abre em somente leitura).</div>
