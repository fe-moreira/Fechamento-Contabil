...
<section id="m-razao">
  ...
  <div class="m-rule"><span class="k">Trava: o nome do arquivo precisa ter o código da empresa</span> Para <b>não correr o risco de importar o arquivo de uma empresa em outra</b> (muitos arquivos do Domínio não trazem o CNPJ), toda importação de <b>dados da empresa</b> — razão, fiscal (entradas/saídas/serviços e o resumo), folha, financeira (extratos e memória), patrimônio, plano de contas e saldo inicial — <b>só aceita o arquivo se o nome dele contiver o código da empresa</b> (o <b>código do Domínio</b>; para filiais, vale também o código da matriz). Se o código não estiver no nome, o sistema <b>bloqueia</b> e pede para renomear (ex.: <b>“1181 razao.xlsx”</b>). Basta o código aparecer como número no nome (com ou sem zeros à esquerda). Importações <b>multiempresa</b> (por CNPJ) e <b>documentos anexos</b> (contratos, atas) não entram nessa trava.</div>
