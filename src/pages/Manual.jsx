...
<section id="m-relatorios">
  ...
  <div class="m-rule"><span class="k">Card único: Relatórios Contábeis</span> Os relatórios contábeis (Financeiro, Balancete, DRE, DFC, Balanço, Comparativo e Pendências) ficam num <b>card só</b> — não abrem na tela, <b>só geram PDF</b> (relatório final pronto pra mandar pro cliente). Clique no card e abre um painel: <b>gere cada um</b> (botão <b>Gerar</b>) ou marque vários e <b>gere todos num PDF único</b>, cada relatório numa página, na ordem <b>Financeiro → Balancete → DRE → DFC → Balanço → Comparativo → Pendências</b>. O <b>Financeiro</b> é o <b>Cockpit</b> em PDF (KPIs, gráfico da evolução no ano, disponibilidades, indicadores e principais clientes). O <b>Comparativo</b> traz as <b>contas de resultado mês a mês</b> (Receitas, Custos e Despesas). <span class="m-muted">DFC (fluxo de caixa, método indireto) entra na próxima atualização (marcado “em breve”).</span></div>
