...
<section id="m-base">
  ...
  <div class="m-rule"><span class="k">Carga inicial — digitar / editar à mão</span> Cada um dos três blocos (saldos, clientes/fornecedores, outras contas) tem os botões <b>Arquivo</b> (subir planilha) e <b>Digitar / editar</b>. No modo digitar você <b>implanta o saldo inicial à mão</b> (uma linha por item, com <b>Adicionar linha</b> e a lixeira para <b>excluir cada linha</b>) — ou <b>corrige o que veio de um arquivo</b>: suba a planilha, mude para <b>Digitar / editar</b> e ajuste linha a linha. Na lista da base, o botão <b>editar</b> reabre a carga para ajustar. Ao informar o código, o <b>nome</b> vem do plano de contas.</div>
</section>
