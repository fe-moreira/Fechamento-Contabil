...
<section id="m-conciliacao">
  ...
  <div class="m-rule"><span class="k">Corrigir em lote</span> Marque vários lançamentos (checkbox) do <b>mesmo cliente/fornecedor</b> e clique em <b>Corrigir</b> na barra: aplica o <b>nome certo</b> a todos de uma vez (ajuste de leitura), com a opção de <b>aprender</b> (não pedir revisão dele depois). Linhas de saldo inicial/acerto são ignoradas nessa correção.</div>
  <div class="m-rule"><span class="k">Conectar (baixa manual)</span> Quando o sistema não casou a nota com o pagamento sozinho (NF diferente, sem NF, ou nomes separados), <b>marque os lançamentos</b> (checkbox na primeira coluna) — pode ser em cards diferentes — e clique em <b>Conectar (baixar)</b> na barra que aparece embaixo. A barra mostra o <b>líquido</b> (se zera) e os conectados vão para <b>Conciliados</b> (dá para reabrir depois).</div>
  <div class="m-rule"><span class="k">Confirmado sai para Conciliados</span> Ao <b>Confirmar</b>, os lançamentos saem do “em aberto” e vão para <b>Conciliados (o que zerou)</b> — some da tela. Para rever ou desfazer, abra <b>“Conferidos neste mês”</b> (no fim da composição) e clique em <b>Reabrir</b>: eles voltam para o em aberto. A baixa automática <b>por NF</b> casa por número da nota <b>dentro de cada cliente</b> (números pequenos, como NF 64, se repetem entre fornecedores — cada par é conciliado separadamente).</div>
