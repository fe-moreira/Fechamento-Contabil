...
<section id="m-integracao">
  ...
  <div class="m-rule"><span class="k">Data que arrasta + filtro por valor + data em lote</span> Quando o relatório traz a <b>data só na 1ª linha do dia</b> e as seguintes vêm em branco, o sistema <b>herda a última data</b> (arrasta para baixo) na importação. Nos filtros dá para procurar por <b>valor</b> (aceita <b>1.200,00</b> ou <b>1200</b>), além de histórico, data, conta e nome. E para os lançamentos que subiram <b>sem data</b>: filtre por <b>Sem data</b>, <b>selecione</b> as linhas e use o campo de <b>data → Data (n)</b> para preencher/alterar a data <b>em lote</b> (recruza o extrato na hora). Do mesmo jeito já existia o <b>aplicar conta em lote</b> e o <b>excluir em lote</b>.</div>
