...
<section id="m-relatorios">
  ...
  <div class="m-rule"><span class="k">Card único: Relatórios Contábeis</span> Os relatórios contábeis (Financeiro, Balancete, DRE, DFC, Balanço, Comparativo e Pendências) ficam num <b>card só</b>. Clique nele e abre um painel onde você <b>gera cada um</b> (botão <b>Gerar</b>) ou marca vários e <b>gera todos num PDF único</b>, na ordem <b>Financeiro → Balancete → DRE → DFC → Balanço → Comparativo → Pendências</b>. O <b>Financeiro</b> é o <b>Cockpit</b> impresso em PDF (receita, resultado, caixa e indicadores). <span class="m-muted">DFC e Comparativo entram na próxima atualização (marcados “em breve”).</span></div>
