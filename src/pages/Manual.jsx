...
<section id="m-demonstracoes">
  ...
  <div class="m-rule"><span class="k">Balanço fecha com o resultado no PL</span> O <b>Balanço</b> (tanto o card em Relatórios quanto o das Demonstrações) usa o <b>mesmo cálculo</b> (<span class="m-code">apurarBalanco</span>): separa Ativo e Passivo+PL pela <b>classificação</b> (grupo 1 e 2) e joga o <b>resultado acumulado do ano</b> — que é a <b>diferença Ativo − (Passivo + PL)</b> — no PL como <b>Lucros do Exercício</b> (se positivo) ou <b>Prejuízo do Exercício</b> (se negativo). Por ser a diferença, <b>Ativo = Passivo + PL</b> sempre fecha, e o valor é o <b>acumulado</b> (não só o mês), sem precisar cadastrar conta de resultado.</div>
