...
<section id="m-integracao">
  ...
  <div class="m-rule"><span class="k">Folha — relatórios de rubricas</span> Na aba <b>Folha</b>, importe os relatórios de rubricas do Domínio (colunas V/W/Z) — o sistema cruza cada rubrica com o razão e mostra a diferença. Há cards para <b>Folha mensal</b> (único obrigatório), <b>Adiantamento</b>, <b>13º Adiantamento</b>, <b>Folha Complementar</b> e <b>Participação de Lucros</b>. Todos os rendimentos importados são <b>somados por rubrica</b> antes de cruzar. Os cards além da folha mensal são <b>opcionais</b>: se não houve no mês, marque <b>Sem movimento</b>; se houve, importe o relatório. <b>Vários arquivos por tipo:</b> ao <b>Subir outro</b> arquivo do mesmo tipo, o sistema pergunta se é para <b>Substituir</b> ou <b>Complementar</b> (soma sem apagar o anterior) — igual à carga inicial de saldos. Cada arquivo do tipo aparece <b>listado</b> no card, com a data, quantas rubricas trouxe, um botão para <b>baixar</b> e um para <b>excluir só aquele arquivo</b> (as rubricas dele saem do total, os outros continuam). <b>Limpar tudo</b> remove todos os arquivos do tipo.</div>
