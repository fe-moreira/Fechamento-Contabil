...
<section id="m-fechamentos">
  ...
  <div class="m-rule"><span class="k">Botões no card (Encerrar / Reabrir)</span> Na lista de <b>Fechamentos</b>, cada card mostra a ação direto: o card <b>Concluído (100%)</b> tem o botão <b>Encerrar</b> (abre o Status para você importar o balancete e encerrar formalmente); o card já <b>Fechado</b> tem o botão <b>Reabrir</b> (só <b>administrador</b>) — que volta a competência para edição. Clicar no card também funciona (o fechado abre a pergunta de reabrir); os botões só deixam a ação visível sem precisar entrar.</div>
