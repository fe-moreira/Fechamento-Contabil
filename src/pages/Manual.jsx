...
<section id="m-integracao">
  ...
  <div class="m-rule"><span class="k">Vários arquivos no mês</span> Ao importar um arquivo quando o banco já tem lançamentos na tela, o sistema pergunta <b>Substituir</b> (troca tudo) ou <b>Complementar</b> (soma os novos aos que já estão — para fechar o mês com mais de um arquivo). Dá também para <b>excluir em lote</b> as linhas selecionadas e filtrar por <b>nome da conta</b> (contém/não contém) e por <b>sem data</b>. Linhas de <b>total/subtotal</b> do relatório não sobem.</div>
</section>
