...
<section id="m-status">
  ...
  <div class="m-rule"><span class="k">Ver lançamentos — buscar e editar em lote</span> No botão <b>Ver lançamentos</b> (lista dos lançamentos que vão para o Domínio) dá para <b>pesquisar</b> por <b>conta</b> (código ou nome), <b>histórico</b> ou <b>valor</b>. Cada linha tem um <b>checkbox</b>: marque <b>quantos quiser</b> (ou <b>todos</b> do filtro pelo checkbox do topo) e escolha <b>o que corrigir</b> nos selecionados — <b>Conta débito</b>, <b>Conta crédito</b>, <b>Histórico</b> ou <b>Centro de custo</b> — informe o novo valor e clique em <b>Aplicar aos N</b>. Combina com a busca: filtre uma conta, selecione todos e aplique de uma vez. O <b>Centro de custo</b> só entra nos lançamentos de <b>conta de resultado</b> (a coluna <b>C. Custo</b> mostra o centro atual ou <b>"sem CC"</b> em amarelo); os demais campos valem para qualquer lançamento. Para ajustar tudo de um lançamento (data, valor, contas, histórico e CC juntos), use o <b>Editar</b> da linha.</div>
</section>
