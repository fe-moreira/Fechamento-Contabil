...
<section id="m-integracao">
  ...
  <div class="m-rule"><span class="k">Cruzar com o extrato (Importado × Extrato)</span> Depois de classificar, clique em <b>Achar diferença por dia</b> e suba o <b>extrato do banco</b>. O sistema tenta achar sozinho as colunas <b>Data</b> e <b>Saldo</b>; se o layout for diferente, abre <b>Ajustar colunas</b> — você escolhe qual coluna é a Data, o Saldo e (opcional) o <b>Valor/movimento</b>, e isso fica <b>salvo por banco</b> (mês que vem lê sozinho). O cruzamento mostra, dia a dia, duas colunas <b>Importado</b> × <b>Extrato</b> (saldo e, se mapeado, o movimento) e aponta a <b>diferença do dia</b>; abrindo um dia, confronta <b>lançamento a lançamento</b> lado a lado: pareia Importado × Extrato pelo <b>valor</b> — o que casa fica <b>verde ✓</b> e o que sobra de cada lado fica <b>vermelho ⚠</b> (é a diferença). No topo do dia mostra os <b>totais</b> (Importado, Extrato e a Diferença), para bater de relance. Dá para reabrir em <b>Ver cruzamento</b> e trocar o mapeamento em <b>Ajustar colunas</b>.</div>
