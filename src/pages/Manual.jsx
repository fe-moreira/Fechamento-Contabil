...
<section id="m-status">
  ...
  <div class="m-rule"><span class="k">Ver lançamentos — buscar e aplicar CC em lote</span> No botão <b>Ver lançamentos</b> (lista dos lançamentos que vão para o Domínio) dá para <b>pesquisar</b> por <b>conta</b> (código ou nome), <b>histórico</b> ou <b>valor</b>. Nos clientes que <b>usam centro de custo</b>, cada lançamento de <b>resultado</b> mostra o seu <b>C. Custo</b> (ou <b>"sem CC"</b> em amarelo) e ganha um <b>checkbox</b>: marque vários — ou <b>todos</b> pelo checkbox do topo — escolha <b>um centro</b> e clique em <b>Aplicar CC aos N</b>. O centro é gravado em cada selecionado com o <b>seu valor cheio</b>. Ideal para carimbar o mesmo CC em massa (ex.: todos os lançamentos de uma conta). Contas patrimoniais não recebem CC e não têm checkbox.</div>
</section>
