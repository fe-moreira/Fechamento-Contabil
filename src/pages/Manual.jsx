...
<section id="m-fechamentos">
  ...
  <div class="m-rule"><span class="k">Balanço Patrimonial (níveis + Domínio)</span> O card <b>Balanço</b> traz a hierarquia (grupo → sintéticas → analíticas) em duas colunas (Ativo | Passivo + PL), com <b>seletor de Nível</b> (padrão 4, igual ao balancete) e botão <b>Gerar balanço (padrão Domínio)</b> em PDF. O <b>resultado do período</b> entra no PL como <b>Lucros/Prejuízo do Exercício</b>, fechando <b>Ativo = Passivo + PL</b>.</div>
