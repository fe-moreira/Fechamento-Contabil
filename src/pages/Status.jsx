...
export default function Status() {
  ...
  const gates = [
    ...
    },
    {
      ...
      // SÓ até o mês selecionado (v.mes <= mesAtualStatus): a divergência de um mês SEGUINTE
      // (ex.: agosto, aberto só para o Comparativo) não é pendência do fechamento de junho/julho.
