...
export async function itensAbertosConta(compId, contaCod, contaNome, classifRaw, aberturaPrevia) {
  ...
  // Sai do em aberto o que foi conciliado (automático por NF+valor+bloco; manual pela auditoria).
  const abertos = descartarBaixadasManuais(lanc, baixados, audit, contaCod)
